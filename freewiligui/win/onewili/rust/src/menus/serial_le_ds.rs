...
impl<'a> SerialLeDs<'a> {
    ...
    pub fn configure_strip(&mut self, strip: i32, gpio: i32, length: i32, led_type: owSerialLEDType, inverted: bool) -> Result<(), OwError> {
        ...
        let _r = crate::transport::call(387 /* CMD_IO_SERIAL_LE_DS_CONFIGURE_STRIP */, &a)?;
        Ok(())
    }
    ...
    pub fn show_config(&mut self) -> Result<(), OwError> {
        ...
        let _r = crate::transport::call(388 /* CMD_IO_SERIAL_LE_DS_SHOW_CONFIG */, &a)?;
        Ok(())
    }
    ...
    pub fn set_le_ds(&mut self, strip: i32, start: i32, count: i32, red: i32, green: i32, blue: i32, white: i32) -> Result<(), OwError> {
        let mut a = crate::transport::Args::new();
        a.i32(strip);
        a.i32(start);
        a.i32(count);
        ...
        a.i32(blue);
        a.i32(white);
        let _r = crate::transport::call(389 /* CMD_IO_SERIAL_LE_DS_SET_LE_DS */, &a)?;
        Ok(())
    }
    ...
    pub fn set_show(&mut self, strip: i32, show: owLEDLightShow) -> Result<(), OwError> {
        ...
        a.i32(strip);
        a.i32(show.0 as i32);
        let _r = crate::transport::call(390 /* CMD_IO_SERIAL_LE_DS_SET_SHOW */, &a)?;
        Ok(())
    }
    ...
    pub fn enable_jambu_orca(&mut self, num_strips: i32) -> Result<(), OwError> {
        let mut a = crate::transport::Args::new();
        a.i32(num_strips);
        let _r = crate::transport::call(391 /* CMD_IO_SERIAL_LE_DS_ENABLE_JAMBU_ORCA */, &a)?;
        Ok(())
    }
    ...
    pub fn auto_show(&mut self) -> Result<(), OwError> {
        let a = crate::transport::Args::new();
        let _r = crate::transport::call(392 /* CMD_IO_SERIAL_LE_DS_AUTO_SHOW */, &a)?;
        Ok(())
    }
}
