...
impl<'a> BleSettings2<'a> {
    ...
    pub fn enable_bt(&mut self) -> Result<(), OwError> {
        ...
        let _r = crate::transport::call(348 /* CMD_WIRELESS_BLUETOOTH_LE_BLE_SETTINGS_ENABLE_BT */, &a)?;
        Ok(())
    }
    ...
    pub fn b_t_terminal(&mut self) -> Result<(), OwError> {
        let a = crate::transport::Args::new();
        let _r = crate::transport::call(349 /* CMD_WIRELESS_BLUETOOTH_LE_BLE_SETTINGS_B_T_TERMINAL */, &a)?;
        Ok(())
    }
    ...
    pub fn b_t_advert_name(&mut self, value: &str) -> Result<(), OwError> {
        ...
        a.str(value);
        let _r = crate::transport::call(350 /* CMD_WIRELESS_BLUETOOTH_LE_BLE_SETTINGS_B_T_ADVERT_NAME */, &a)?;
        Ok(())
    }
}
