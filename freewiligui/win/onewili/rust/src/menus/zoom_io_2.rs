...
impl<'a> ZoomIo2<'a> {
    ...
    pub fn enable_rx_stream(&mut self, enable: i32) -> Result<(), OwError> {
        ...
        a.i32(enable);
        let _r = crate::transport::call(160 /* CMD_SCRIPTING_ZOOM_IO_ENABLE_RX_STREAM */, &a)?;
        Ok(())
    }
    ...
    pub fn send_data(&mut self, delay: i32, data: &[u8]) -> Result<(), OwError> {
        ...
        a.i32(delay);
        a.bytes(data);
        let _r = crate::transport::call(161 /* CMD_SCRIPTING_ZOOM_IO_SEND_DATA */, &a)?;
        Ok(())
    }
    ...
    pub fn update_table_data(&mut self, table_index: i32, delay: i32, data: &[u8]) -> Result<(), OwError> {
        ...
        a.i32(delay);
        a.bytes(data);
        let _r = crate::transport::call(162 /* CMD_SCRIPTING_ZOOM_IO_UPDATE_TABLE_DATA */, &a)?;
        Ok(())
    }
    ...
    pub fn enable_schedule_table(&mut self, number_of_entries: i32) -> Result<(), OwError> {
        ...
        let _r = crate::transport::call(163 /* CMD_SCRIPTING_ZOOM_IO_ENABLE_SCHEDULE_TABLE */, &a)?;
        Ok(())
    }
    ...
    pub fn compile_test(&mut self) -> Result<(), OwError> {
        ...
        let _r = crate::transport::call(164 /* CMD_SCRIPTING_ZOOM_IO_COMPILE_TEST */, &a)?;
        Ok(())
    }
    ...
    pub fn run_zio(&mut self, path: &str) -> Result<(), OwError> {
        let mut a = crate::transport::Args::new();
        a.str(path);
        let _r = crate::transport::call(165 /* CMD_SCRIPTING_ZOOM_IO_RUN_ZIO */, &a)?;
        Ok(())
    }
    ...
    pub fn stop_zio(&mut self) -> Result<(), OwError> {
        let a = crate::transport::Args::new();
        let _r = crate::transport::call(166 /* CMD_SCRIPTING_ZOOM_IO_STOP_ZIO */, &a)?;
        Ok(())
    }
}
